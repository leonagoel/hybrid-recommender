...
def test_similar_items_endpoint_returns_recommendations_for_item_id(
        api_client):
...
def test_similar_items_endpoint_filters_by_category_case_insensitive(
        api_client):
    ...
    assert {item["category"]
            for item in payload["recommendations"]} == {"Audio"}
