...
def test_weight_matrix_warm_user_override():
    ...
    a, b, g = h._get_active_weights(
        0.5, 0.4, 0.1, user_id=42, candidate_titles=None)
    tot = 0.2 + 0.7 + 0.1
